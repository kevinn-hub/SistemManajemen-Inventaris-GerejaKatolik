...
if(isset($_POST['tambah'])){
  ...
  $status_anggota   = $_POST['status_anggota'];
    ...
    $insert = mysqli_query($koneksi,"UPDATE tbl_anggota SET nama_anggota='$nama_anggota', npm='$npm', fakultas='$fakultas', prodi='$prodi', angkatan='$angkatan', no_hp='$no_hp', alamat='$alamat', status_anggota='$status_anggota' WHERE id_anggota='$id_anggota' ");
    if ($insert) {
